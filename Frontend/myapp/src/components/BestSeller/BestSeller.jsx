...
const BestSeller = () => {
  ...
  return (
    <section className="px-3" style={{ marginTop: "5rem" }}>
      ...
      <div className="row g-4 ">
        {products.map((product) => (
          <div key={product.id} className="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-3" onMouseEnter={() => setHoveredCard(product.id)}
            onMouseLeave={() => setHoveredCard(null)}
          >
            <div className="card border-0 text-center">
              <div style={{ position: "relative", borderRadius: "12px", overflow: "hidden", }}> {/* Image Container */}
                <img
                  src={
                    hoveredCard === product.id
                      ? product.colorImages[product.colors[1] || product.colors[0]]
                  ...
                  style={{
                    ...
                    height: "400px",
                    borderRadius: "12px",
                    transition: "all 1.3s ease, opacity 0.3s ease",
                    transform: hoveredCard === product.id ? "scale(1.1)" : "scale(1)",
                    opacity: hoveredCard === product.id ? 0.8 : 1,
                  }}
                />
                {/* Sale Time Badge */}
                {product.saleTime && (
                  <div
                    ...
                    style={{
                      position: "absolute",
                      left: "50%",
                      bottom: hoveredCard === product.id ? !product.sizes ? "20%" : screenSize.width > 576 ? "30%" : "20%" : '12px',
      ...
      <div className="text-center my-4">
        ...
        <button
          className="btn"
          style={{ padding: "8px 32px", border: "1px solid black", fontWeight: "bold" }}
        >See more</button>
      </div>
